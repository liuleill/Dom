...
var div = dom.create("<div>divAfter</div>");
dom.after(test, div);
var divBefore = dom.create("<div>divBefore</div>");
dom.before(test, divBefore);
var div3 = dom.create('<div id="parent">this</div>');
dom.wrap(test, div3);
var nodes = dom.empty(window.empty);
console.log("hello");
console.log(nodes); //把test的title改成hi,i am leilei
...
dom.each(dom.children(t), function (n) {
  return dom.style(n, "color", "purple");
});
